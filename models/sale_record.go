...
func CheckIfTheExchange(ctx context.Context, orderId, salesmanId int64, orderItemIds string) error {
	...
	logrus.WithField("Response > ========:", response).Info("CheckIfTheExchange")
	if !response.Success {
